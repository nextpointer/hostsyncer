...
// States for Setting pages
// state for masternode config true or not
export const [IsMasterNodeConfig,setMasterNodeConfig] = createSignal<boolean>(false);
// state for theme apperannce
export const [theme, setTheme] =createSignal<string>("system");
// state for access key button
export const [isKeyButtonClicked,setKeyButtonClicked] = createSignal<boolean>(false);